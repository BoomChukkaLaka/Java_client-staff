...
public class QuestionViewController implements ChatClient {
    ...
    private void doHandle(String msg) {
        if (msg.equals(".bye")) {
            ...
            try {
                ...
                correctAns=model.correctAnswerProperty().getValue().intValue();
    ...
    public void initialize() {
        btnSendClientView.setOnAction(ev -> {
            ...
            if (model != null && answer != 0 && txtWord11.getText() != null && !txtWord11.getText().trim().isEmpty()) {
                send(model.toString());
                if (Integer.parseInt(txtWord1.getText())!=correctAns){
                    System.out.println("Not Correct answer");
                }else {
                    System.out.println("Correct Answer");
                }
                Answer answer1=new Answer();
                answer1.getStage(String.valueOf(correctAns),txtWord1.getText());
            }
    ...
    void setBtnExitClientViewAction(ActionEvent event) {
        ...
        new PromptStaffController().getStage("PromptStaff.fxml");
    }
